...
class BookArchive:
    ...
    def insert_book_in_repository(self):
        for book in self.file_book[1:]:
            list_book = book.split(";")
            book = Book(int(list_book[0]), list_book[1], list_book[2], list_book[3], list_book[4], self.format_str_price_to_float(list_book[5]))
